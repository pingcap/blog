---
title: Titan Storage Engine Design and Implementation
author: ['Zhiquan Zheng']
date: 2019-04-25
summary: Based on the RocksDB source, Titan is a new storage engine available for preview in TiDB 3.0 and  its design is inspired by Wisckey. This post introduces the design and implementation of Titan.
tags: ['Engineering']
...
The Titan storage engine is a new storage engine available for preview in TiDB 3.0. Titan is based on the RocksDB source, and is designed to reduce write amplification when using large values. The design is inspired by [WiscKey](https://www.usenix.org/system/files/conference/fast16/fast16-papers-lu.pdf), a paper issued in USENIX FAST 2016.
