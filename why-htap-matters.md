...
date: 2019-09-15
author: ['Shawn Ma']
summary: This post talks about why HTAP matters in a database platform, and how TiDB implements HTAP and how you can apply TiDB in  different scenarios.
...
HTAP support is also available on [TiDB Cloud](https://en.pingcap.com/products/tidbcloud), the fully managed TiDB service. Apply now for a 2-week free trial [here](https://en.pingcap.com/products/tidbcloud/trial).
