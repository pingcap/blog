...
![]({{ site.baseurl }}/assets/img/tangsir.jpg)
...
![]({{ site.baseurl }}/assets/img/curve.jpg)
...
![]({{ site.baseurl }}/assets/img/timeline.jpg)
...
![]({{ site.baseurl }}/assets/img/kvarchi.jpg)
...
![]({{ site.baseurl }}/assets/img/multi.jpg)
...
### <span id="scale">Scale Out</scale>

#### Scale-out (initial state)

![]({{ site.baseurl }}/assets/img/scale2.jpg)
...
![]({{ site.baseurl }}/assets/img/scale3.jpg)
...
![]({{ site.baseurl }}/assets/img/write.jpg)
...
![]({{ site.baseurl }}/assets/img/group.jpg)
