...
Generally speaking, Rust is mainly used to develop server-side applications with high performance at this stage. In addition, its innovation in the type system and syntaxes gives it a unique edge in developing Domain-Specific Libraries (DSL).
