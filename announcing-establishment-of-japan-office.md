...
image: /images/blog/announcing-new-operations-in-japan.png
tags: ['Announcement']
categories: ['Company']
press_release: true
---
...
![Announcing New Operations in Japan](media/announcing-new-operations-in-japan.png)
...
PingCAP has adopted open source as a core strategy of developing and promoting the next-gen database, especially in the context of cloud-native computing. TiDB has been open source since day one with its two sibling projects: TiKV, a distributed key-value storage, and Chaos Mesh®, a cloud-native chaos engineering platform. Both [TiKV](www.tikv.org) and [Chaos Mesh®](www.chaos-mesh.org) have been widely adopted around the world and are in [Cloud Native Computing Foundation](www.cncf.io) (CNCF) Graduated and Sandbox stages, respectively. In addition, PingCAP has been among the top 10 of the CNCF global contribution ranking list for the past 2 years in a row.
