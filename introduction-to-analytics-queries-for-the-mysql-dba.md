...
<div class="trackable-btns">
    <a href="https://pingcap.com/download" onclick="trackViews('Introduction to Analytics Queries for the MySQL DBA', 'download-tidb-btn-middle')"><button>Download TiDB</button></a>
