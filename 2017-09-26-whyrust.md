...
<div class="trackable-btns">
    <a href="https://pingcap.com/download" onclick="trackViews('Why did we choose Rust over Golang or C/C++ to develop TiKV?', 'download-tidb-btn-middle')"><button>Download TiDB</button></a>
